    ...
    <ul className="max-w-full overflow-x-auto flex flex-row gap-4 ">
      {homeCategoryList.map((item) => (
        <li
          ...
          className={cn(
            "flex justify-center items-center border border-transparent min-w-fit bg-[rgba(144,144,144,0.2)] hover:bg-[rgba(144,144,144,0.45)] text-white p-2 rounded-md cursor-pointer",
